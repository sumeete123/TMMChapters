    ...
    <div className="admin-content">
      ...
      {tab === "reviews" && <>
        <div className="metric-strip admin-metrics">
          <div><span>Submitted this week</span><strong>{currentWeekReportChapters.size}</strong><small>of {data.chapters.filter((chapter) => chapter.status === "active" && !chapter.is_official).length} active chapters</small></div>
