...
export default function Home() {
  ...
  return (
    <main className="site-shell">
      ...
      {view === "signin" && <SignInView onSubmit={handleSignIn} sent={signInSent} denied={portalDenied || adminDenied} />}
